...
%% extract propagation (separately for full craniotomy and thin bone)
...
zScores = zscore(propagation_fullCraniotomy);
...
%% Propagation compare fullCraniotomy vs thinBone (violin graph)
...
for experiment = 1:33 %length(FilesAll)
