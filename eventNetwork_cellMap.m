function [networkData, newTempMap] = propagationCellMap(networkData, currentEvent, simultaneousEvents_current)
    % Function to process event network and propagate event data

    % Cell Map
    tempMap = networkData.cellMap_all{currentEvent}{simultaneousEvents_current};
