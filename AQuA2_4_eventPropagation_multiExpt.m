...
cd V:\2photon\Simone\Simone_Macrophages\AQuA2_Results\fullCraniotomy\baseline\3._analysisByEvent.mat;
...
for i = 1:length(FilesAll)
    ...
    tempTable = table(propagationSpeed, propagationDistance, duration, fileNameColumn, ...
...
propagation_fullCraniotomy = load( ...
    'D:\2photon\Simone\Simone_Macrophages\AQuA2_Results\fullCraniotomy\baseline\AQuA2_data_fullCraniotomy_propagation.mat');
...
%% Propagation fullCraniotomy ONLY
...
propagation_fullCraniotomy_notOutliers = propagationTable(notOutliers_fullCraniotomy);
...
zScores = zscore(cell2mat(propagationTable.Speed));
